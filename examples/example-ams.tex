...
\address{Duke University, Department of Mathematics}
...
Here you can see the same document as \texttt{example.tex} but formatted just like it was in an American Mathematical Society journal.
This can be useful for submission to journals, who sometimes have formatting expectations or ask for things in \texttt{amsart} for length comparison purposes.
...
It should work for \texttt{\textbackslash{}cite} and \texttt{\textbackslash{}textcite} but I have not implemented it for any other citation commands.
